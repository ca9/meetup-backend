...
class EndpointsAuth(object):
    """
      Sets the Authorization header using an Existing Bearer Token
      as found on Endpoints Authorized calls.
      Made by: Aditya Gupta
    """

    def __init__(self):
        """
        A helpful initialization for endpoints. Plays nice with gdata api.
